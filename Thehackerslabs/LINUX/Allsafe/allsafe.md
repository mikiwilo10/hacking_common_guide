...
┌──(kali㉿kali)-[~/Documents/mrRobot]
└─$ nmap -sS --min-rate 5000 -p- --open -n -Pn 192.168.56.6 -oN scan.txt  
...
┌──(kali㉿kali)-[~/Documents/mrRobot]
└─$ nmap -p22,80,2222 -sV -sC -Pn -vvv -n -oN fullScan.txt 192.168.56.6    
...
192.168.56.6 allsafe.thl

-------------------------------------------------------------------------------------------------------------------------------

```bash 
wfuzz -c --hc=404,200 --hl=1 -w /usr/share/wordlists/SecLists/seclists/Discovery/DNS/subdomains-top1million-5000.txt     -H "HOST: FUZZ.allsafe.thl" -u 192.168.56.6 
```
...
192.168.56.6 allsafe.thl intranet.allsafe.thl
```
...
=============================================================================================================================================================================================                                                                                                                                                    
┌──(kali㉿kali)-[~/Documents/mrRobot]
└─$ ssh -i id_rsa.fixed parker@192.168.56.6 -p 2222 
...
goddard@ae3ff527ff85:~$ Read from remote host 192.168.56.6: Connection reset by peer
...
┌──(kali㉿kali)-[~/Documents/Go-Hash]
└─$ ssh cisco@192.168.56.6    
cisco@192.168.56.6's password: 
