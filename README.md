...
```bash
sudo nmap -sS --min-rate 5000 -p- --open -n -Pn 10.201.73.14 -oN scan.txt
```
...
```bash
nmap -p135,139,3268,3269,3389,389,445,464,47001,49664,49665,49666,49668,49670,49671,49673,49677,49691,49695,49848,53,593,5985,636,80,88,9389 -sV -sC -Pn -vvv -n 10.201.73.14 -oN fullScan.txt 
```
